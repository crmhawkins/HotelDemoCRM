...
class BankinterScraperService
{
    ...
    {
        // [DEMO 2026-04-17] Guard modo demo: no ejecutar puppeteer contra Bankinter
        if (\App\Services\DemoModeService::isStubbed('bankinter')) {
            \App\Services\DemoModeService::stubResponse('bankinter', 'descargarMovimientos', [
                'cuenta' => $cuentaAlias,
            ...
            return [
                ...
                'file' => null,
                'cuenta' => $cuentaAlias,
                'mensaje' => '[DEMO] Descarga de movimientos Bankinter simulada (no se ha conectado al banco real)',
                'movimientos' => [],
            ];
        }
