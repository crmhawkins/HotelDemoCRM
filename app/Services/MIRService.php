...
class MIRService
{
    ...
    {
        // [DEMO 2026-04-17] Guard modo demo: no hacer SOAP real al Ministerio
        if (\App\Services\DemoModeService::isStubbed('mir')) {
            $loteFake = 'DEMO' . now()->format('YmdHis');
            \App\Services\DemoModeService::stubResponse('mir', 'enviarReserva', [
            ...
            return [
                ...
                'lote' => $loteFake,
                'estado' => 'enviado',
                'mensaje' => '[DEMO] Envío MIR simulado correctamente',
            ];
        }
