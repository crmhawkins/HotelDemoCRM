                ...
                <div class="card-body p-4">
                    <form action="{{ route('admin.edificio.store') }}" method="POST" id="edificio-form">
                        ...
                        <div class="mb-4">
                            ...
                            @php $valorTipoCerradura = old('tipo_cerradura_principal', 'manual'); @endphp
                        ...
                        <input type="hidden" name="metodo_entrada" id="metodo_entrada" value="{{ old('metodo_entrada', 'fisica') }}">

                        <script>
                            function toggleCerraduraEdificio() {
                                var tipo = document.querySelector('input[name="tipo_cerradura_principal"]:checked').value;
                                document.getElementById('tuyalaravel-building-section').style.display = (tipo === 'ttlock' || tipo === 'tuya') ? '' : 'none';
                                document.getElementById('metodo_entrada').value = (tipo === 'manual') ? 'fisica' : 'digital';
